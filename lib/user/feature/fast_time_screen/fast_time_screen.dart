...
import 'fast_time_view_model.dart';


class FastTimeScreen extends StatelessWidget {
  const FastTimeScreen({super.key});

  @override
  Widget build(BuildContext context) {

    final Size screenSize = MediaQuery.of(context).size;
    final FastTimeViewModel userDataModel =
    Provider.of<FastTimeViewModel>(context);
                            ...
                            children: [
                              ...
                              Expanded(
                                ...
                                child: Container(
                                  ...
                                  color: Colors.white,
                                  child: Consumer<FastTimeViewModel>(
