          ...
          body: SingleChildScrollView(
            child: Column(
              children: [
                ...
                FormComponent(
                  hintText: 'Full Name: ${registerViewModel.nameController.text}',
                ),
                SizedBox(
                  height: screenSize.height * 0.02,
                ),
                FormComponent(
                  hintText: 'Email Address: ${registerViewModel.emailController.text}',
                ),
                Padding(
                  ...
                  child: InternationalPhoneNumberInput(
                    ...
                    hintText: '${registerViewModel.phoneNumber}',
                  ),
                ),
                FormComponent(
                  hintText: 'Password: ${registerViewModel.passwordController.text}',
                  obscureText: true,
                ),
                SizedBox(
